...
# It's a little more complicated than the other example, but it includes some basic
...
# you want to run this specific demo. If you have trouble installing it, try any of the
# other demos that don't require it instead.
...
known_face_encodings = list(
    map(
        lambda x: face_recognition.face_encodings(
            face_recognition.load_image_file(x["image_location"])
        )[0],
        PERSONS,
    )
)
